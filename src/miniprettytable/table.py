...
class PrettyTable:
    ...
    def get_html_string(self, *, format: bool = False, xhtml: bool = False, escape_header: bool = True, escape_data: bool = True, **_kwargs) -> str:
        ...
        - escape_header: when True, HTML-escape header text (default True)
        - escape_data: when True, HTML-escape data cell text (default True)
